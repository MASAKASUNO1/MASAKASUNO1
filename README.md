...
<h2 align="left">🧑‍💻 Languages and Tools, 開発ツール:</h2>

- Next.js/ReactNatveを用いた開発を主にしています。
...
|年度|主な業績|
| -------------- | ------------------------------------------------------- |
| 2016 | 地元高専から九州大学へ編入しました |
| 2016 | インターンをきっかけに大学を中退しソフトウエアエンジニアとしてのキャリアを開始しました |
| 2017 | 個人開発としてアプリ開発者を始めました.最初のリリースアプリはリマインダーiOS |
| 2017 | 開発したサービスが日・韓・台の３カ国で無料総合１位を獲得。モバイルアプリ会社へ |
| 2018 | 良い時期になったので開業。ITサービスの企画・開発・運営、インターネットメディアの運用をはじめました |
| 2019 | iOSのアプリストアの合計DL数は約350万へ |
| 2019 | Web開発にも本腰を入れ始めました。現在でも主事業になっています |
| 2020-2021 | SNSマーケティングにも本腰を入れ始めました。Twitterでは総フォロワー数万、Youtubeでは銀の盾(登録者10万人以上)を達成しました |
| 2022 | 主事業で行なっているサービスの累計ページViewが1億回を突破しました |
